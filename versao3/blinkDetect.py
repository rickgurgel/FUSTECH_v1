...
while(validFrames < dummyFrames):
    ...
    if landmarks == 0:
        validFrames -= 1
        cv2.putText(frame, "Face não detectada... Ajuste a iluminação...", (10, 30), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1, cv2.LINE_AA)
...
if __name__ == "__main__":
    ...
    while(1):
        try:
            ...
            if drowsy:
                cv2.putText(frame, "ESTADO DE SONOLENCIA", (70, 50), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 255), 2, cv2.LINE_AA)
                if not ALARM_ON:
                    ALARM_ON = True
                ...
                cv2.putText(frame, "PISCOU:{}".format(blinkCount), (460, 80), cv2.FONT_HERSHEY_COMPLEX, 0.8, (0,0,255), 2, cv2.LINE_AA)
                # (0, 400)
                ALARM_ON = False
